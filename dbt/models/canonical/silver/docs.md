...
- value_parsed is a validated numeric value; missing values are forward-filled from the last valid observation when available, while invalid/out-of-range values are excluded.
